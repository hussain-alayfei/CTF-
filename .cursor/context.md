...
| 7 | Web Applications | Authored **v2.1 live** | **Dynamic** (10: 3E / 4M / 3D, **no files**) |
| 8–10 | Placeholders | Locked, empty | — |

Days 1–2 were deleted. Day numbers are plain ints (3–10).

**Day 7 IDs (v2.1):** `d7_markup_trail`, `d7_side_door`, `d7_desk_wizard` (easy) · `d7_role_chip`, `d7_twin_check`, `d7_frame_whisper`, `d7_stash_order` (medium) · `d7_inherited_trust`, `d7_cross_talk`, `d7_flash_seat` (danger: pollution / null-origin postMessage / 180ms race).

**Day 7 model (v2.1):** all live browser labs under `src/pages/day7/`. **Zero `asset_url` files.** Manual: `ADMIN_MANUAL_DAY7.md`. Code: `WEB-2026`. Migrations: `20260712_2200_day7_webapps_live_v2.sql` + `20260712_2230_day7_three_real_dangers.sql`.
